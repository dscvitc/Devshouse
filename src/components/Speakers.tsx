...
const Speakers = () => {
  const speakers: Speaker[] = [
    {
      name: 'Anushka Sadaria',
      position: 'Data Scientist',
      company: 'Microsoft',
      link: "https://images.pexels.com/photos/3764119/pexels-photo-3764119.jpeg?auto=compress&cs=tinysrgb&w=600"
    },
    {
      name: 'Anushka Sadaria',
      position: 'Data Scientist',
...
const SpeakerCard = ({ name, position, company,link }: Speaker) => {
  return (
    <div className='relative'>
      <svg width="0" height="0" style={{ position: 'absolute', overflow: 'hidden', width: "300px" }}>
        <defs>

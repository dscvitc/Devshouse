...
export default function Prizes() {
    ...
    const tracks = [//Individual prize tracks 
        {
            trackName: "Company A",
        ...
        },
        {
            trackName: "Company D",
            trackLogo: "/images/icons-track-prize.png",
            trackText: "Cutting-edge hardware innovations, from IoT to embedded systems, pushing tech boundaries: Prize - INR 5,000.",
            color: '#42000A'
        },
        {
            trackName: "Company E",
    ...
    return (
        <section className="w-screen flex flex-col justify-center items-center overflow-hidden mb-8" style={{ backgroundImage: `url('/images/bgLayer.png')` }}>
            <h1 className="text-white text-[35px] font-bold font-['Space Grotesk'] mt-6 sm:text-[40px] md:txt[45px] lg:[54px]">Prizes</h1>

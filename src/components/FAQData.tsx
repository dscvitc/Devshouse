const FAQData = [
  ...
  {
    key: 5,
    question: "I am interested in participating, but cannot find a team. What do I do?",
    answer:
      "This is an opportunity for you to explore! Join our discord server and we have specifically dedicated a channel for team building.",
    color: "red",
  },
  {
    key: 6,
  ...
  {
    key: 8,
    question: "Will the hackathon be offline or online?",
    answer: "The hackathon will be completely offline.",
    color: "green",
  },
  {
    key: 9,
    question: "Do I need to give the Demo of the product I have built?",
    answer:

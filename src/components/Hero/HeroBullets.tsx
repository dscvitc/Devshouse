      ...
      <div className={`${classes.inner} flex flex-col-reverse md:flex-row gap-14}`}>
        <div className={classes.content}>
          ...
          <Group mt={30}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="26" viewBox="0 0 34 26" fill="none" style={{marginRight:" 10px"}}>
...
<path d="M36.1799 21.8394C36.1799 31.1994 29.1599 38.8194 20.2799 39.5994C20.2799 39.5994 8.81986 39.8994 5.03986 39.5394C3.59986 39.3594 2.39986 38.4594 1.85986 37.1394C2.39986 37.3794 2.93986 37.5594 3.53986 37.6194C4.79986 37.7394 6.89986 37.7994 9.83986 37.7994C14.1599 37.7994 18.8999 37.6794 18.8999 37.6794H18.9599C23.6999 37.2594 28.0799 35.0994 31.1999 31.5594C33.8999 28.5594 35.6399 24.7794 36.1199 20.8194C36.1799 21.1194 36.1799 21.4794 36.1799 21.8394Z" fill="black"/>
<path d="M34.8 17.9994C34.8 27.3594 27.78 34.9794 18.84 35.6994C18.84 35.6994 7.38 35.9994 3.6 35.6394C1.56 35.4594 0.06 33.5394 0 31.3794L0.06 4.37938C0.12 2.21938 1.68 0.299377 3.72 0.119377C7.5 -0.180623 18.96 0.179377 18.96 0.179377C27.84 0.959377 34.8 8.63937 34.8 17.9994Z" fill="black"/>
